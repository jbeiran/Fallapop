...
public class FallapopForm extends javax.swing.JFrame {
    ...
    public FallapopForm(Fallapop m){
        ...
        listUsuarios = this.model.getUsuarios();
        for (int i = 0; i < listUsuarios.size(); i++) {
            System.out.println(listUsuarios.get(i).getNombre());
        }

        for (int i = 0; i < listUsuarios.size(); i++) {
            System.out.println(listUsuarios.get(i).getTelefono());
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FallapopForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FallapopForm().setVisible(true);
            }
        });
    }
